...
\begin{document}
    ...
    \input{Base_loci/text.tex}
    \input{Iitaka_fibrations/text.tex}
    \input{Volume_and_bigness/text.tex}
    \input{Zariski_decomposition/text.tex}
    \input{BDPP_criterion/text.tex}
    \input{Appendix_of_notes/text.tex}
