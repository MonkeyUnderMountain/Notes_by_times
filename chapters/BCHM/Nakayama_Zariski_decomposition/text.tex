\section{Nakayama Zariski Decomposition}

  We work over an algebraically closed field $\kkk$ of characteristic zero. 
  We use $\bbK$ to denote the coefficient of divisors, which can be either $\bbQ$ or $\bbR$.
...
\subsection{Classical Zariski Decomposition}
  ...
  \begin{theorem}
    Let $X$ be a smooth projective surface and $D$ be a pseudo-effective $\bbK$-divisor on $X$. 
    Then there exists a unique decomposition
    \[ D = P + N \]
    with $P$ being nef $\bbK$-divisor and $N = \sum_i a_i E_i$ being effective $\bbK$-divisor 
    such that 
  ...
  \begin{proposition}
    Let $D$ be a pseudo-effective $\bbK$-divisor on a smooth projective surface $X$ with Zariski decomposition $D = P + N$. Then we have
  ...
  \begin{corollary}
    Let $D$ be a pseudo-effective $\bbK$-divisor with Zariski decomposition $D = P + N$.
    Then $\vol(D) = P^2$.
   \Yang{}
  \end{corollary}
