...
\title{Convex and algebraic geometry}
\author{Tianle Yang}
\date{\today}
...
\begin{document}
    ...
    \input{text.tex}
    \input{Fundamental_convex_geometry/text.tex}
    \input{Lorentzian_polynomial/text.tex}
    \input{Relation_and_conversion/text.tex}
